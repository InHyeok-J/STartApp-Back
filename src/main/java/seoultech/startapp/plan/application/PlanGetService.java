...
class PlanGetService implements PlanGetUseCase {
    ...
    public PlanPagingResponse getAllPlanByPaging(int page,int count) {

        Page<PlanResponse> planResponses = loadPlanPort.loadAllPlanByPaging(PageRequest.of(page,count))
